(defproject daomei "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot daomei.clj.core
  :profiles {:uberjar {:main daomei.clj.core, :aot :all}}
  :plugins [[lein-cljsbuild "LATEST"]]
  :cljsbuild {:builds
              [{:id "dev"
                :source-paths ["src/daomei/cljs"]
                :compiler
                {:output-to "resources/public/js/development/index.js"
                 :source-map true
                 :output-dir "resources/public/js/development"
                 :optimizations :none
                 :main daomei.cljs.core
