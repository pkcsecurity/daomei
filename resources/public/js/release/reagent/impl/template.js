...
var G__14021 = o;
(G__14021[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__14025 = o;
(G__14025[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__14030 = props;
var G__14030__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14030,cljs.core.cst$kw$id,id):G__14030);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14030__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__14031){
...
var props = map__14032__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14032__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__14032,map__14032__$1,props,class$){
return (function (c){
...
});})(map__14032,map__14032__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14034){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14035__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__14035,map__14035__$1,on_write){
return (function (){
...
});})(node_value,map__14035,map__14035__$1,on_write))
);
} else {
...
var G__14038 = jsprops;
(G__14038["defaultValue"] = value);

(G__14038["onChange"] = ((function (G__14038,v,value,on_change){
return (function (p1__14037_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14037_SHARP_);
});})(G__14038,v,value,on_change))
);
...
var vec__14041 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14041,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14041,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14041,(2),null);
...
var jsprops = ({"argv": v});
var temp__5541__auto___14045 = reagent.impl.template.key_from_vec(v);
if((temp__5541__auto___14045 == null)){
} else {
var key_14046 = temp__5541__auto___14045;
...
var temp__5541__auto___14047 = reagent.impl.template.key_from_vec(argv);
if((temp__5541__auto___14047 == null)){
} else {
var key_14048 = temp__5541__auto___14047;
reagent.impl.template.oset(jsprops,"key",key_14048);
}
...
var G__14049 = reagent.impl.template.__GT_NativeWrapper();
(G__14049["name"] = c);
...
var G__14050 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14050) : reagent.impl.template.as_element.call(null,G__14050));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14053){
var G__14054 = cljs.core.first(seq14053);
var seq14053__$1 = cljs.core.next(seq14053);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14054,seq14053__$1);
});
...
break;
default:
var G__14060 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__14060;
continue;
...
var n__4408__auto___14062 = a.length;
var i_14063 = (0);
while(true){
if((i_14063 < n__4408__auto___14062)){
(a[i_14063] = reagent.impl.template.as_element((a[i_14063])));

var G__14064 = (i_14063 + (1));
i_14063 = G__14064;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___14065 = a.length;
var i_14066 = (0);
while(true){
if((i_14066 < n__4408__auto___14065)){
var val_14067 = (a[i_14066]);
if(((cljs.core.vector_QMARK_(val_14067)) && ((reagent.impl.template.key_from_vec(val_14067) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_14066] = reagent.impl.template.as_element(val_14067));
...
var ctx = ({});
var vec__14069 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14069,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14069,(1),null);
...
var G__14072 = (cljs.core.count(argv) - first_child);
switch (G__14072) {
case (0):
...
case (1):
var G__14073 = comp;
var G__14074 = jsprops;
var G__14075 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__14073,G__14074,G__14075) : reagent.impl.template.global$module$react.createElement.call(null,G__14073,G__14074,G__14075));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__14072){
