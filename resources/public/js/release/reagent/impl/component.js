...
if((i < len)){
var k = (ks[i]);
var G__13883 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13884 = (i + (1));
m = G__13883;
i = G__13884;
continue;
...
var temp__5539__auto__ = (p["argv"]);
if((temp__5539__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13885 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__13885) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__13885));
})());
} else {
var v = temp__5539__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__13887 = c;
var G__13887__$1 = (((G__13887 == null))?null:G__13887.prototype);
if((G__13887__$1 == null)){
return null;
} else {
return (G__13887__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__13889 = c;
var G__13889__$1 = (((G__13889 == null))?null:G__13889.prototype);
if((G__13889__$1 == null)){
return null;
} else {
return (G__13889__$1["render"]);
}
})() == null))));
});
...
var G__13891 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13891) : reagent.impl.component.as_element.call(null,G__13891));
};
...
while (G__13894__i < G__13894__a.length) {G__13894__a[G__13894__i] = arguments[G__13894__i + 0]; ++G__13894__i;}
  args = new cljs.core.IndexedSeq(G__13894__a,0,null);
} 
...
var _STAR_current_component_STAR_13897 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13897;
}});
...
return ((function (G__13898,G__13898__$1){
...
var c = this;
var G__13903_13905 = (c["cljsRatom"]);
if((G__13903_13905 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13903_13905);
}
...
var renders_13907 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13908 = cljs.core.first(cljs.core.vals(renders_13907));
if((cljs.core.count(renders_13907) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13907))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13908)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13908], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__13906 = name;
switch (G__13906) {
case "":
...
var G__13911 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__13911) : reagent.impl.component.global$module$create_react_class.call(null,G__13911));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__13912 = fiber;
var G__13912__$1 = (((G__13912 == null))?null:(G__13912["type"]));
if((G__13912__$1 == null)){
return null;
} else {
return (G__13912__$1["displayName"]);
}
})();
var parent = (function (){var G__13913 = fiber;
if((G__13913 == null)){
return null;
} else {
return (G__13913["return"]);
}
})();
var path = (function (){var G__13914 = parent;
var G__13914__$1 = (((G__13914 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__13914) : reagent.impl.component.fiber_component_path.call(null,G__13914)));
if((G__13914__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13914__$1)," > "].join('');
}
})();
...
var temp__5535__auto__ = (function (){var or__3949__auto__ = (function (){var G__13916 = c;
if((G__13916 == null)){
return null;
} else {
return (G__13916["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__13917._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__13919 = c;
if((G__13919 == null)){
return null;
} else {
return (G__13919["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__13921 = c;
if((G__13921 == null)){
return null;
} else {
return G__13921._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__13923 = instance;
if((G__13923 == null)){
return null;
} else {
return (G__13923["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__13924 = instance;
if((G__13924 == null)){
return null;
} else {
return G__13924._currentElement;
}
}
})();
var name = (function (){var G__13925 = elem;
var G__13925__$1 = (((G__13925 == null))?null:(G__13925["type"]));
if((G__13925__$1 == null)){
return null;
} else {
return (G__13925__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__13927 = elem;
if((G__13927 == null)){
return null;
} else {
return (G__13927["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__13928._owner;
}
}
})();
var path = (function (){var G__13929 = owner;
var G__13929__$1 = (((G__13929 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__13929) : reagent.impl.component.component_path.call(null,G__13929)));
if((G__13929__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13929__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__13930 = c;
var G__13930__$1 = (((G__13930 == null))?null:G__13930.constructor);
if((G__13930__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13930__$1);
}
}
})();
