...
(def pri "rgba(111, 217, 216, 1)")
(def pri-light "rgba(111, 217, 216, .8)")
(def sec "rgba(243, 71, 83, 1)")
(def sec-light "rgba(243, 71, 83, .8)")
...
(def index
  (html/html {:mode :html}
             ...
             [:body
              ...
              [:script {:async :async
                        :defer :defer
                        :src "https://maps.googleapis.com/maps/api/js?key=YOURKEYHERE&callback=daomei.cljs.view.map.init_map"}]]))
